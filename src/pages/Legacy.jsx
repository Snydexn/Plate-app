...
const Legacy = () => {
  ...
  // Produk statis awal (silakan edit sesuai asetmu)
  const products = [
  ...
  // Produk dinamis dari localStorage untuk SECTION + kategori yang dipilih
  ...
  // Filter berdasarkan kategori aktif (kalau ada)
        ...
        <div className="w-3/4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {filteredProducts.map(product => (
              <div key={product.id} className="bg-white rounded-2xl overflow-hidden shadow-sm flex flex-col transition-transform duration-200 hover:-translate-y-1 hover:shadow-md">
                {/* Gambar */}
